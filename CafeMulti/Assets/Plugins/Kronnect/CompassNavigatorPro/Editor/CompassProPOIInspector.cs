...
namespace CompassNavigatorPro {
    ...
    public class CompassProPOIInspector : Editor {
        ...
        SerializedProperty miniMapType, miniMapVisibility, miniMapVisibleDistanceOverride, miniMapClampPosition, miniMapShowRotation, miniMapRotationAngleOffset, miniMapIconScale;
