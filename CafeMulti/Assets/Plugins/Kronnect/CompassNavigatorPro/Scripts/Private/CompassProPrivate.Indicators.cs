...
namespace CompassNavigatorPro {
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        void UpdateIndicators() {
            ...
            float vextentsX = (0.5f - _offScreenIndicatorMargin) * _offScreenIndicatorRect.width;
            float vextentsY = (0.5f - _offScreenIndicatorMargin * aspect) * _offScreenIndicatorRect.height;
            ...
            for (int k = 0; k < poiCount; k++) {
                ...
                if (isOnScreen) {
                    ...
                    scale = _onScreenIndicatorScale * 0.25f * poi.onScreenIndicatorScale;
                } else {
                    ...
                    if (visible) {
                        ...
                        scale = _offScreenIndicatorScale * 0.25f * poi.onScreenIndicatorScale;
                        vpos.x -= 0.5f;
                        vpos.y -= 0.5f;
                        if (vpos.z < 0) {
                            vpos *= -1f;
